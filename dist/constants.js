...
export var CardanoConstants;
(function (CardanoConstants) {
    CardanoConstants[CardanoConstants["ADA_COIN_TYPE"] = 1815] = "ADA_COIN_TYPE";
    CardanoConstants[CardanoConstants["ADA_TEST_COIN_TYPE"] = 1] = "ADA_TEST_COIN_TYPE";
    CardanoConstants[CardanoConstants["CHANGE_INDEX"] = 0] = "CHANGE_INDEX";
    CardanoConstants[CardanoConstants["CHIMERIC_INDEX"] = 2] = "CHIMERIC_INDEX";
    CardanoConstants[CardanoConstants["CARDANO_BASE_ADDRESS_MIN_LENGTH"] = 57] = "CARDANO_BASE_ADDRESS_MIN_LENGTH";
    CardanoConstants[CardanoConstants["CARDANO_PAYMENT_CREDENTIAL_OFFSET"] = 29] = "CARDANO_PAYMENT_CREDENTIAL_OFFSET";
    CardanoConstants[CardanoConstants["ADA_DECIMALS"] = 6] = "ADA_DECIMALS";
    CardanoConstants[CardanoConstants["MIN_FEE_A"] = 44] = "MIN_FEE_A";
    CardanoConstants[CardanoConstants["MIN_FEE_B"] = 155381] = "MIN_FEE_B";
    /**
     * Bytes per Ed25519 signature witness in the CBOR-encoded transaction
     */
    CardanoConstants[CardanoConstants["TX_WITNESS_SIZE_BYTES"] = 139] = "TX_WITNESS_SIZE_BYTES";
    /**
     * Maximum iterations for the transaction-fee convergence loop
     */
    CardanoConstants[CardanoConstants["TX_FEE_MAX_ITERATIONS"] = 5] = "TX_FEE_MAX_ITERATIONS";
    /**
     ...
     */
    CardanoConstants[CardanoConstants["UTXO_LOCK_TTL_MS"] = 120000] = "UTXO_LOCK_TTL_MS";
    /**
     ...
     */
    CardanoConstants[CardanoConstants["MAX_TX_INPUTS"] = 100] = "MAX_TX_INPUTS";
    /**
     ...
     */
    CardanoConstants[CardanoConstants["MIN_UTXO_BASE_LOVELACE"] = 1000000] = "MIN_UTXO_BASE_LOVELACE";
})(CardanoConstants || (CardanoConstants = {}));
export var CardanoAmounts;
(function (CardanoAmounts) {
    CardanoAmounts[CardanoAmounts["DEPOSIT_AMOUNT"] = 2000000] = "DEPOSIT_AMOUNT";
    /**
     ...
     */
    CardanoAmounts[CardanoAmounts["STAKING_TX_FEE"] = 300000] = "STAKING_TX_FEE";
    /**
     * Fee for governance operations (DRep delegation, DRep registration)
     * These transactions involve governance certificates
     */
    CardanoAmounts[CardanoAmounts["GOVERNANCE_TX_FEE"] = 1000000] = "GOVERNANCE_TX_FEE";
    /**
     * Deposit required to register as a DRep on Cardano mainnet (Conway era)
     * 500 ADA = 500,000,000 lovelace
     */
    CardanoAmounts[CardanoAmounts["DREP_REGISTRATION_DEPOSIT"] = 500000000] = "DREP_REGISTRATION_DEPOSIT";
    /**
     ...
     */
    CardanoAmounts[CardanoAmounts["ESTIMATED_MAX_FEE"] = 500000] = "ESTIMATED_MAX_FEE";
    /**
     ...
     */
    CardanoAmounts[CardanoAmounts["MIN_UTXO_PER_POLICY_LOVELACE"] = 150000] = "MIN_UTXO_PER_POLICY_LOVELACE";
    /**
     ...
     */
    CardanoAmounts[CardanoAmounts["COINS_PER_UTXO_BYTE"] = 4310] = "COINS_PER_UTXO_BYTE";
    CardanoAmounts[CardanoAmounts["TX_TTL_SECS"] = 7200] = "TX_TTL_SECS";
    /**
     ...
     */
    CardanoAmounts[CardanoAmounts["TX_FEE_INITIAL_ESTIMATE"] = 200000] = "TX_FEE_INITIAL_ESTIMATE";
    /**
